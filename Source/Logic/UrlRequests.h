...
public:
  ...
  URLFetcher(const juce::String &request, const juce::StringPairArray &queryParams, std::function<void(const juce::String &)> callback) : juce::ThreadPoolJob("URLFetcher"),
                                                                                                                                          requestType(request),
